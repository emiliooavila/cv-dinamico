    ...
    <div style={{ padding: '30px 20px', minHeight: 'calc(100vh - 65px)', backgroundColor: 'var(--code-bg)', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      ...
      {!hasData && (
        <div className="no-print" style={{ 
          ...
          ⚠️ Tu currículum está vacío. Ve al <Link to="/editor" style={{ color: '#7b341e', fontWeight: '700', textDecoration: 'underline' }}>Editor</Link> para capturar tus datos antes de previsualizar o exportar.
        </div>
      )}
